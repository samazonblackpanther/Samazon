...
//        user.setHistory(history);
        ...
        product= new Product ("AICOOK Compact Juice Fountain 700-Watt Juice Extractor ", "Kitchen", 99.95, "Heavy-duty compact juice fountain with centered knife blade assembly 700-watt motor operates at 14,000 RPM for maximum extraction ; Safety Locking Arm: Juicer will not operate without juicer cover in place and safely locking arm in place in the vertical operating position.Pulp Container Capacity: 1.6 qt Pulp Container ", "https://res.cloudinary.com/db9bfssj4/image/upload/v1560107261/aaaa__umeta4.jpg");
        productRepository.save(product);

        product= new Product ("Weber 45030001 Spirit II E-310 Red LP Outdoor Gas Grill  ", "Kitchen", 389.00, "Boasts the Gs4 grilling system with improved infinity ignition, burners, porcelain-enameled Flavorizer Bars, grease Management system, and 529 Square inches of cooking space over three burners \n" +
                "Porcelain-enameled, cast iron cooking grates. Left table down width is 42 inches.30, 000 BTU-per-hour input main burners with fuel gauge Open cart design with six tool hooks and two large wheels  ", "https://res.cloudinary.com/db9bfssj4/image/upload/v1560108253/grill__qtxciu.jpg");
        productRepository.save(product);

        product= new Product ("Cuisinart CPT-180 Metal Classic 4-Slice toaster, Brushed Stainless ", "Kitchen", 57.00, "Dual control panels make this two toasters in one with smooth brushed stainless housing \n" +
                "Custom control: 6-setting browning dials, dual reheat, defrost and bagel buttons with LED indicators. 1-1/2 inch - wide toasting slots, Extra-lift carriage lever, slide-out crumb tray and convenient cord storage   ", "https://res.cloudinary.com/db9bfssj4/image/upload/v1560108470/toaster_rhr021.jpg");
        productRepository.save(product);
        ...
        product= new Product ("Nespresso Vertuo Coffee and Espresso Machine Bundle with Aeroccino Milk Frother ", "Kitchen", 57.00, "AUTOMATIC COFFEE/ESPRESSO MACHINE: Have the ability to create barista grade brewed single serve coffee or espresso cups at the touch of a single button. The single touch button mechanism delivers the best in-cup result for whatever style coffee or espresso drink you choose. Designed for use with Nespresso Vertuo capsules only \n" +
                "VERSATILE COFFEE AND ESPRESSO MAKER: Brew 5 different single serve coffee cup sizes at the touch of a button depending on your coffee needs - Espresso (1.35 oz.), Double Espresso (2.7 oz.), Gran Lungo (5 oz.), Coffee (7.7 oz.) and Alto (14 oz). Pour over ice to create your favorite iced coffee and ice latte drinks   ", "https://res.cloudinary.com/db9bfssj4/image/upload/v1560109101/esspreso_vkk0uf.png");
        productRepository.save(product);

        product= new Product ("Bluetooth Body Fat Smart Scale USB Rechargeable Digital Bathroom Weight Scale Body Fat Monitor with Smartphone App ", "Health", 57.00, "The RENPHO app measures weight, Body Fat%, BMI, Muscle Mass, Bone Mass, and more. It display graphs that track progress in these various metrics. You can weigh anytime WITHOUT turning on the APP. The data will sync to the app once it is connected again! LONG-LASTING RECHARGEABLE BATTERY - With lithium battery takes only 3-4 hours to fully charge for a battery life of 2-3 months. Charge via any USB source.Rechargeable scale no need for purchasing batteries, save your money and the planet.   ", "https://res.cloudinary.com/db9bfssj4/image/upload/v1560112462/golf_beurq6.jpg");
        productRepository.save(product);

        product= new Product ("Neoprene Dumbbell Pairs and Sets with Stands  ", "Health", 88.99, "Set of six cast iron dumbbells in three weight categories with storage stand. Neoprene-coated for durability, safety, and a non-slip grip. Color-coded for weight: green (5 lb), navy blue (10 lb), and dark grey (15 lb). Burn calories and build muscles with dynamic weight training and cardio. Pre-assembled, foldable steel stand in a tiered triangular shape  ", "https://res.cloudinary.com/db9bfssj4/image/upload/v1560112941/dumbell__ekn3ya.jpg");
        productRepository.save(product);

        product= new Product ("Orgain Organic Plant Based Protein Powder  ", "Health", 19.90, "21 grams of organic plant based protein (pea, brown rice, chia seeds), 7 grams of organic dietary fiber, 3 grams of net carbs, 0 grams of sugar, 150 calories per serving. USDA organic, vegan, gluten free, dairy free, lactose free, low net carbs, no added sugar, soy free, kosher, non-GMO, carrageenan free, and no artificial ingredients", "https://res.cloudinary.com/db9bfssj4/image/upload/v1560114351/protien__da9eku.jpg");
        productRepository.save(product);

        product= new Product ("BlenderBottle Classic Loop Top Shaker Bottle,  ", "Health", 15.49, "Pack of two, 28-ounce capacity (note: measurements only go to 20 ounces) shaker cups for mixing protein shakes, smoothies, and supplements. Patented mixing system uses 316 surgical-grade stainless steel BlenderBall wire whisk found only in BlenderBottle brand shaker bottles. Screw-on lid creates leak-proof seal, and flip cap snaps securely shut to keep contents contained; loop top for easy carrying or attaching key", "https://res.cloudinary.com/db9bfssj4/image/upload/v1560114485/shaker__zsftuf.jpg");
        productRepository.save(product);
